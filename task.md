...
- [x] **5.1** Nav2 konfigürasyonu (AMCL, Costmaps, Planner, Controller)
- [x] **5.2** Tek robot için `2D Goal Pose` harita testi
- [x] **[İNSAN ONAYLANDI]** Robot RViz'de harita üzerinde verilen hedefe engellere çarpmadan gidiyor.

---

## 🚦 AŞAMA 6 — Çoklu Robot Navigasyonu (Multi-Robot Nav2)
- [x] **6.1** 3 robot için eşzamanlı Nav2 başlatılması
- [x] **6.2** Her robota kendi isim uzayı (`/worker_X`) altında hedef verilmesi
- [x] **[İNSAN ONAYLANDI]** 3 robot aynı haritada birbirlerine çarpmadan kendi hedeflerine ulaşıyor.

---

## 🦾 AŞAMA 7 — Manipülasyon & Kol Kontrolü (`colony_manipulation` - MoveIt 2)
- [x] **7.1** MoveIt 2 SRDF ve kinematics konfigürasyonu
- [x] **7.2** Robot kolunun Pick/Place eylemi simülasyonu
- [x] **[İNSAN ONAYLANDI]** Robot hedefe ulaştığında robot kolu kalkıp nesneyi alma hareketi yapıyor.
